    ...
    return (
        <>
            ...
            <div className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0 bg-white dark:bg-slate-800">
                <div className="fixed top-0 right-0 px-6 py-4 sm:block bg-white dark:bg-slate-800">
                    {props.auth.user ? (
                ...
                <div className="max-w-6xl mx-auto sm:px-6 px-2 lg:px-8 bg-white dark:bg-slate-800">
