...
export default function Chat(props) {
    ...
    }, []); // Пустий масив залежностей означає, що useEffect виконається тільки при монтуванні компонента
    ...
    const sendMessage = (e) => {
        e.preventDefault();
        //axios send to routs /message/sent
        axios.post('/chat', {
            message: input,
    ...
    return (
        <Authenticated
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-white leading-tight">Chat</h2>}
        >
            <Head title="Chat"/>
